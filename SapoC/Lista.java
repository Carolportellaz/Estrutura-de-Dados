public class Lista {
        ...
        if (quebra_galho.elemento == posicao) {
            ...
            while (distancia_frente != null || distancia_tras != null || pulo == 1) {
                if (pulo == 1) {
                    ...
                    System.out.println("A posicao atual é " + no_posicao_atual.elemento);
                }
                    ...
                    if (distancia_frente == null) {
                        no_posicao_atual = distancia_tras;
                        pulo++;
                    }

                    else if (distancia_tras == null) {
                        ...
                        System.out.println("O valor do calculo F é " + calculo_frente);

                        calculo_tras = distancia_tras.elemento - posicao;
                        calculo_tras = Math.abs(calculo_tras);
                        System.out.println("O valor do calculo T é " + calculo_tras);
    ...
    public No puloF() {
        ...
        if (pulo == 1) {
            ...
            System.out.println("Valor do quebra g dentro " + quebra_galho.elemento);
